...
const ConfirmWithdraw = ({setWithdraw, setWithdrawConfirm, withdrawConfirm}) => {
            ...
            <div className="modal h-screen modal-bottom sm:modal-middle">
                <div className="modal-box bg-blue-100 h-screen sm:h-auto px-2 py-4 sm:py-8 sm:px-4">
                    <div className='text-xl text-center font-bold text-accent'>
                       ...
                       <h2 className='text-2xl font-bold text-green-500'>Your Withdraw Request <span className='text-accent'>{withdrawConfirm?.amount} tk</span> is successfully</h2>
                    </div>
                    <div className='w-full p-2 sm:p-3 shadow-md mt-4 rounded-md bg-white'>
                        <div className='rounded-md p-3 bg-slate-200'>
                            <p className='s'>ধন্যবাদ আপনার রিকুয়েস্ট টি সফল হয়েছে 30 মিনিটের মধ্যে ডিপোজিট ব্যালেন্স আপনার একাউন্টে যুক্ত করে দেওয়া হবে।</p>
                        </div>
