                ...
                <div className="modal-box bg-blue-100 h-screen sm:h-auto px-2 py-4 sm:py-8 sm:px-4">
                    ...
                    <div className='w-full p-2 sm:p-3 shadow-md mt-4 rounded-md bg-white'>
                        <div className='rounded-md p-3 bg-slate-200'>
                            <p className='shalimar'>Withdraw channel</p>
                        ...
                        <p className='p-2 text-[16px] text-gray-700'>Withdraw Amount: <span className='text-secondary text-[14px]'>( Minimum 1000 )</span></p>
                        <form className='w-full mt-4'>
                            <input type="number" placeholder="Enter Withdraw Amount" class="input input-sm input-bordered w-full" required />
                            <input type="submit" value="Withdraw Now" className="btn shalimar w-full mt-5 mb-3 btn-primary rounded-2xl text-white btn-sm" />
                        </form>
                    </div> 
