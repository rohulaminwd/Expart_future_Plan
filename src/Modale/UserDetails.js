...
const UserDetails = ({setOpenUserDetails, refetch, openUserDetails}) => {
    const {firstName, lastName, imageURL, address, phoneNumber, gender, age, roleNo, role} = openUserDetails
        ...
        <div>
            ...
            <div className="modal modal-bottom sm:modal-middle">
                ...
                <div className="bg-[#f7f2f7] relative !p-0 mb-10 sm:pb-0  h-screen modal-box w-full sm:!w-11/12 !max-w-5xl">
                    <label htmlFor="user-details" className="btn z-50 btn-sm btn-circle absolute right-2 top-2">✕</label>
                    <div style={{ backgroundImage: `url(${bg1})` }} className='bg-cover -z-10 w-full relative overflow-hidden rounded-b-[100px] h-[280px] sm:h-[320px] bg-gradient-to-t from-cyan-500 to-blue-500'>
                            ...
                            <div className='cursor-pointer mb-9 relative w-28 h-28 sm:w-36 sm:h-36 mx-auto flex justify-center pt-6'>
                                ...
                                {!imageURL && 
                                    <div className='relative w-28 h-28 sm:w-36 sm:h-36'>
                                        ...
                                        <UserProfileImg me={openUserDetails} textColor='sm:text-[70px] ring-offset-[3px] text-[60px] text-white' className='w-28 h-28 sm:w-36 bg-secondary sm:h-36 ring-[6px] ' />
                                    </div>
                                }
                            </div> 
                            <p className='text-3xl mt-3 font-bold text-white text-center'>{firstName} {lastName}</p>
                            <p className='text-xl sm:mt-1 font-bold text-[#f0e0fc] text-center'>{address}</p>
                        </div>
