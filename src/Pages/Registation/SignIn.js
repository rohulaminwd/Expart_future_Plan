...
const SignIn = () => {
  ...
  const onSubmit = (i) => {
    ...
    if (ph?.length >= 11) {
      setLoading(true);
      setError("");
      fetch("https://expart-plan.vercel.app/api/v1/auth/login", {
        method: "POST",
        headers: {
        ...
        .then((status) => {
          ...
          if (status.success === true) {
            const accessToken = status.data.accessToken;
  ...
  return (
    ...
    >
      <div className="h-screen bg-[#111f3b75] flex items-end sm:items-center justify-center w-full">
        <div
          className="w-full sm:w-[500px] bg-base-100 rounded-3xl sm:rounded-b-3xl rounded-b-none p-5 sm:p-8 shadow-md"
              ...
              <div className="form-control mb-5 w-full">
                ...
                <div className="relative">
                  ...
                  <div
                    ...
                    } cursor-pointer  absolute top-[12px] right-2`}
                  >
