...
import { AiOutlineArrowLeft, AiOutlineArrowRight, AiOutlineCodeSandbox } from 'react-icons/ai'
...
const SignUp = () => {
    ...
    const onSubmit = async data => {
        ...
        const user = {
            ...
            referCode: refer,
            myReferralCode: data?.firstName?.slice(0, 1) + data?.lastName?.slice(0,1) + ph?.slice(4, )
        }
    ...
    return (
        <div style={{ backgroundImage: `url(${signInBg})` }} className='bg-cover  h-screen'>
            <div className='h-screen bg-[#111f3b75] flex items-end sm:items-center justify-center w-full'>
                <div className="w-full sm:w-[500px] bg-base-100 rounded-3xl sm:rounded-b-3xl rounded-b-none p-3 py-5 sm:py-8 sm:p-8 shadow-md" data-aos="zoom-in-down" data-aos-delay="100" data-aos-duration="800">
                    <div className="text-center">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="flex w-full justify-between gap-x-3">
                                <div className="form-control w-full">
                                    <label className="label">
                                        <span className="label-text text-cyan-900 font-bold">First Name</span>
                                    </label>
                                    <input 
                                        type="text" 
                                ...
                                <div className="form-control w-full">
                                    <label className="label">
                                        <span className="label-text text-cyan-900 font-bold">Last Name</span>
                                    </label>
                                    <input 
                                        type="text" 
                            ...
                            <div className='w-full flex items-center justify-between gap-3'>
                                ...
                                <div className="form-control w-full">
                                    <label className="label">
                                        <span className="label-text text-cyan-900 font-bold">Confirm Password</span>
                                    </label>
                                    <div className='relative'>
                                    <input 
                                        type={oldPassType} 
