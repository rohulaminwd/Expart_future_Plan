...
import {MdWorkOutline, MdNotificationsNone, MdDetails, MdOutlineDashboard, MdOutlineRequestPage} from 'react-icons/md'
                        ...
                        <ul className=" menu overflow-y-auto">
                            <li className='font-bold my-1'>
                                ...
                                >
                                    ...
                                    <h1 className={`origin-left whitespace-nowrap duration-300 font-medium ${!open && 'scale-0 hidden'}`}>Home</h1>
                                </NavLink>
                            </li>
                            <li className='font-bold my-1'>
                            ...
                            <li className='font-bold my-1'>
                                <NavLink to='/admin-dashboard/withdraw-requested'
                                className={({ isActive }) =>
                                    isActive ? 'border-r-[4px] border-primary rounded-l-md text-[#156c65] bg-[#d6f8f5]' : 'hover:bg-[#d6f8f5]'
                                }
                                >
                                    <MdOutlineRequestPage size={'20px'} /> 
                                    <h1 className={`origin-left whitespace-nowrap duration-300 font-medium ${!open && 'scale-0 hidden'}`}>Request</h1>
                                </NavLink>
                            </li>
                            <li className='font-bold my-1'>
                                <NavLink to='/admin-dashboard/adminWork'
                                    className={({ isActive }) =>
                                    isActive ? 'border-r-[4px] border-primary rounded-l-md text-[#156c65] bg-[#d6f8f5]' : 'hover:bg-[#d6f8f5]'
                                 }
                                >
                            ...
                            <li className='font-bold my-1'>
                                <NavLink to='/admin-dashboard/adminPlan'
                                    className={({ isActive }) =>
                                    isActive ? 'border-r-[4px] border-primary rounded-l-md text-[#156c65] bg-[#d6f8f5]' : 'hover:bg-[#d6f8f5]'
                                 }
                                >
                                    <BsPerson size={'20px'} /> 
                                    <h1 className={`origin-left whitespace-nowrap duration-300 font-medium ${!open && 'scale-0 hidden'}`}>Plan</h1>
                                </NavLink>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="fixed px-3 p-1 bottom-0 left-0 border-t border-[#bed6cd] sm:hidden w-full bg-white">
                    <ul className='flex justify-between items-center'>
                        ...
                        <li className=''>
                            ...
                            >
                                <div className='flex justify-center'>
                                    <MdOutlineRequestPage size={'24px'} /> 
                                </div> 
                                <p className={`text-[12px] font-bold`}>request</p>
                            </NavLink>
                        </li>
                        <li className=''>
                            <NavLink to='/admin-dashboard/adminWork'
