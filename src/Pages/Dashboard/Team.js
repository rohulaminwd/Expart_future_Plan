    ...
    <div className="w-full p-2 sm:py-3 sm:px-0">
      <div className="flex justify-between gap-3 sm:gap-5 items-center">
        <label
          ...
          htmlFor="user-info"
          className="p-3 gap-1 sm:p-4 flex items-center sm:gap-2 w-full cursor-pointer hover:-translate-y-1 duration-300 shadow-sm bg-[#fff] rounded-lg"
        >
          ...
          <div className="">
            ...
            <h1
              ...
              className="text-[14px] text-[#727988] sm:text-xl"
            >
              Team Size
            </h1>
          </div>
      ...
      <div className="p-3 gap-1 sm:p-4 mt-4 flex items-center sm:gap-2 w-full cursor-pointer hover:-translate-y-1 duration-300 shadow-sm bg-[#fff] rounded-lg">
        ...
        <div className="">
          ...
          <h1
            style={{ lineHeight: "16px" }}
            className="text-[16px] text-[#727988] sm:text-xl"
          >
            Team Investment
          </h1>
        </div>
      ...
      <div className="mt-5">
        <div className="text-center text-gray-800 p-3 py-5 sm:p-5 shadow-md rounded-lg bg-white">
          ...
          <p className="text-[12px] sm:text-[16px] mx-auto mt-2 sm:mt-3 sm:w-[60%] text-gray-700">
            Invite your friends by sharing this refer link and get bonus and{" "}
          </p>
          <div className="flex mx-auto rounded-lg sm:mt-5 mt-2 gap-2 sm:gap-3 max-w-[500px] items-center">
            <div className="p-1 sm:p-2 border w-full rounded-md">
              <p className="max-w-[500px] text-[12px]">
            ...
            <div className="">
              ...
              >
                {({ copied, copy }) => (
                  <Button
                    className={`${copied ? "bg-[#177865]" : "bg-[#174e78]"}`}
                    onClick={copy}
                  >
                    {copied ? "Copied" : "Copy"}
                  </Button>
